...
*/
  ...
  const onSlide = async (id) => {
   ...
   if(resultFotosProdutos.data.length <= 0)  return toast.error("Produto não possui fotos")
  ...
  const onCadastrarFotos = async (arquivo) => {
    ...
    const resultUpload  = await Api.post(`/produtos/fotos/cadastro/${idProdutos}`, formData);
            ...
            {dadosProdutos.map((itens, index) => (
              <tbody>
                <tr>
                  ...
                  <td>{formatarMoedas(itens.custoReposicao)}</td>
                  ...
                  <td>
                    <a
                      className="btn-link"
                      onClick={() => onAnexarFotos(itens.id)}
                    >
                      Anexar Foto
                    </a>
                  </td>
          ...
          <div className="row g-3">
            <div className="col-sm-12">
              ...
              <input
                ...
                onChange={(e) => onChangeDesSecaoGrupoSubGrupo(e)}
              />
            </div>
          </div>
        </form>
          ...
          {dadosFotos.map((item, index) => (
            <ContainerImagem key={index}>
              <div>
                ...
                />
                <span>{item.nome ? item.nome : item.descricao}</span>
              </div>
              <ListaIcons>
                {!item.descricao ? (
        ...
        <form className="form-horizontal" onSubmit={formik.handleSubmit}>
          <div className="row g-3">
            <div className="col-sm-8">
              <label className="control-label has-error">Descrição</label>
              <input
                className={
            ...
            <div className="col-sm-4 ">
              ...
              <div className="input-group ">
                <select
                  className={
                    formik.touched.lojaId && formik.errors.lojaId
                      ? "form-control is-invalid"
                      : "form-control"
                  }
                  name="lojaId"
                ...
                >
                  ...
                  {dadosLoja.map((itens, index) => (
                    <option value={itens.codigo} key={index}>
                      {itens.codigo} - {itens.razaoSocial}
                    </option>
                  ))}
                </select>
              </div>
          ...
          <div className="row g-3 ">
            <div className="col-sm-4 ">
              ...
              <div className="input-group ">
                <select
                  className={
                    formik.touched.secaoId && formik.errors.secaoId
                      ? "form-control is-invalid"
                      : "form-control"
                  }
                  name="secaoId"
                ...
                >
                  {dadosSecao.length <= 0 && <option>Nenhum</option>}
                ...
                {formik.errors.secaoId && formik.touched.secaoId ? (
                  <Error>{formik.errors.secaoId}</Error>
                ) : null}
                <button
                  class="input-group-text"
                  type="button"
                  onClick={() => onExibirModalCadastroRapido("secao")}
                >
            ...
            <div className="col-sm-4">
              ...
              <div className="input-group ">
                ...
                {formik.errors.grupoId && formik.touched.grupoId ? (
                  <Error>{formik.errors.grupoId}</Error>
                ) : null}
                <button
                  class="input-group-text"
                  type="button"
                  onClick={() => onExibirModalCadastroRapido("grupo")}
                >
                  <FontAwesomeIcon icon={faPlus} color="#18A0FC" />
                </button>
              </div>
            ...
            <div className="col-sm-4">
              <label className="control-label">Sub Grupo</label>
              <div className="input-group ">
                <select
                  className={
                    formik.touched.subGrupoId && formik.errors.subGrupoId
                      ? "form-control is-invalid"
                      : "form-control"
                  }
                  name="subGrupoId"
                ...
                >
                  {dadosSubGrupo.length <= 0 && <option>Nenhum</option>}
                ...
                {formik.errors.subGrupoId && formik.touched.subGrupoId ? (
                  <Error>{formik.errors.subGrupoId}</Error>
                ) : null}
                <button
                  class="input-group-text"
                  type="button"
                  onClick={() => onExibirModalCadastroRapido("subGrupo")}
                >
                  <FontAwesomeIcon icon={faPlus} color="#18A0FC" />
                </button>
              </div>
          ...
          <Separador>
            <div className="row g-3">
              <div className="col-sm-2">
                <label className="control-label">Custo Contabil</label>
                <NumberFormat
                  name="custoContabil"
                  ...
                  className={
                    formik.touched.custoContabil && formik.errors.custoContabil
                      ? "form-control is-invalid"
                      : "form-control"
                  }
                />
              ...
              <div className="col-sm-2">
                <label className="control-label">Custo Nota</label>
                <NumberFormat
                  name="custoNota"
                  ...
                  fixedDecimalScale={true}
                  className={
                    formik.touched.custoNota && formik.errors.custoNota
                      ? "form-control is-invalid"
                      : "form-control"
                  }
                />
              ...
              <div className="col-sm-2">
                <label className="control-label">Reposição</label>
              ...
              <div className="col-sm-2">
                <label className="control-label">Preço Venda</label>
          ...
          <div className="row g-3">
            <div className="col-sm-2">
              <label className="control-label">Em estoque</label>

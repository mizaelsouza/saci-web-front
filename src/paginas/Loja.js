...
import { HeaderLista, Separador } from "../componentes/Styles/EstiloComum";
...
export default function Loja() {
    ...
    const onChangeMask = (e, tipo) => {
        if (tipo === "telefone") {
            setDadosLoja({
                telefone: mask(unMask(e.target.value), MaskTelefone),
            });
    ...
    return (
        <div>
            ...
            >
                <form
                    onSubmit={formiLoja.handleSubmit}
                        ...
                        <div className="row g-3">
                            <div className="col-sm-1">
                                ...
                                <select
                                    ...
                                    name="ufId"
                                    onChange={(e) =>
                                        onFiltrarCidadeUf(e.target.value)
                                    }
                                >
                            ...
                            <div className="col-sm-4">
                                ...
                                <div className="input-group">
                                    <select
                                        className="form-control"
                                        name="municipioId"
                                        {...formiLoja.getFieldProps(
                                            "municipioId",
                                        )}
                                    >
                                        <option>Nenhum</option>
                                        {dadosListaCidade.map(
                                            (itens, index) => (
                                                <option
                                                    value={itens.id}
                                                    key={index}
                ...
                >
                    ...
                    <div className="row g-3">
                        <div className="col-sm-6">
                            ...
                            <input
                                className={
                                    formiLoja.touched.razaoSocial &&
                                    formiLoja.errors.razaoSocial
                    ...
                    <div className="row g-3">
                        <div className="col-sm-6">
                            ...
                            <input
                                className={
                                    formiLoja.touched.cnpj &&
                                    formiLoja.errors.cnpj
                                        ? "form-control is-invalid"
                                        : "form-control"
                                }
                                type="text"
                    ...
                    <Separador>
                        <div className="row g-3">
                            <div className="col-sm-6">
                                ...
                                <input
                                    className={
                                        formiLoja.touched.email &&
                                        formiLoja.errors.email
                                            ? "form-control is-invalid"
                                            : "form-control"
                                    }
                                    type="text"
